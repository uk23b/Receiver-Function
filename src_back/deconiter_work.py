...
for event_folder in event_folders:
    ...
    for (network, station_name) in station_files_dict:
        ...
        output_file_r = os.path.join(output_event_folder, f"{network}_{station_name}_{gauss}.i.r.SAC")
        output_file_t = os.path.join(output_event_folder, f"{network}_{station_name}_{gauss}.i.t.SAC")
        output_file_z = os.path.join(output_event_folder, f"{network}_{station_name}_{gauss}.i.z.SAC")
