...
main_path = '/Volumes/UNTITLE/17_Hermann/test32/JOINT/'
# work folder
work_folder = 'work'

# main path that contains all the receiver function files
main_path_rec = '/Volumes/UNTITLE/17_Hermann/test32/JOINT/data/CCP_RFs/'
...
for i in range(len(rec_files)):
    ...
    # #rftn96 39
    subprocess.call(['rftn96', cleanup], stdout=f5)
    subprocess.call(['rftn96', '32' ,damping], stdout=f5)
    subprocess.call(['rftn96', '36' ,dif_smoothing], stdout=f5)
    subprocess.call(['rftn96', '33' ,time_start, '34', time_end], stdout=f5)
    ...
    subprocess.call(['rftn96', '18'], stdout=f5)
    subprocess.call(['rftn96', '28'], stdout=f6)
